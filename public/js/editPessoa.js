$('#btn-adicionar-classe').click(function() {
    ...
    var string = `<tr id="tr-${hash}" class="tr-tbody-add-classe"> <td><button class="btn-tr-tbody-delete-classe" type="button" id="${hash}"><i class="bx bx-trash" style="font-size: 1.6em"> </i></button></td><td><select id="select-classe-${hash}"></select></td><td><select id="select-funcao-${hash}"></select></td></tr>`;
