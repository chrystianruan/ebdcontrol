...
<div class="container" style="margin-left:15%;width: 70% ">
       <header style="background-color: red; padding: 5px; border-radius: 5px 5px 0 0; box-shadow: 0 0 0.2em black  "> Saída(-) | {{$dataAtual}}<font style="float:right;">$</font></header>
        <form action="/admin/financeiro/saida" method="POST" style="min-height: 300px !important; ">
            @csrf
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field" style="width: 130px;">
                            <label>⠀</label>
                            <input type="number" style="border-radius: 0 10px 10px 0" name = "valor" step="0.01"  min="0" required placeholder="Valor gasto">
                        </div>

                        <div class="input-field" style="width: 200px;margin-left: 3% ">
                            <label>Tipo da Saída <font style="color:red;font-weight: bold">*</font></label>
                        ...
                        <div class="input-field" style="width: 200px;margin-left: 3%">
                            <label>Categoria da Saída <font style="color:red;font-weight: bold">*</font></label>
                        ...
                        <div class="input-field"  style="width: 200px; margin-left: 3%">
                            <label>Data da Saída<font style="color:red;font-weight: bold">*</font> </label>
                            <input type="date" name="data_cad" placeholder="Digite a data de nascimento" required max="{{date('Y-m-d')}}">
                        </div>
