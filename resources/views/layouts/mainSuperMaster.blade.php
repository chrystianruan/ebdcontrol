...
<head>
    ...
    <link rel="stylesheet" href="{{ cacheBust('css/barMaster.css') }}">
...
<div class="topnav" id="myTopnav">
    <a href="/super-master" class="active"><i class="fa fa-home"></i>SuperMaster</a>
    <div class="dropdown">
        <button class="dropbtn"><i class="fa fa-filter"></i>Filtro
            <i class="fa fa-caret-down"></i>
        </button>
        <div class="dropdown-content">
            <a href="/super-master/filters/users"><i class="fa fa-user"></i>Usuários</a>
            <a href="/super-master/filters/congregacoes"><i class="fa fa-home"></i>Congregações </a>
        </div>
    </div>
