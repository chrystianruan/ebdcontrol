...
@section('content')
    ...
    @if (date('w') == 0 || date('Y-m-d') == $dateChamadaDia)
        @if(auth()->user()->pessoa->situacao == 1)
            @if(!$presente)
                        ...
                        <div class="card-body">
                            @if(count($pessoaSalas) > 1)
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="pessoa_sala" required>
        ...
        @else
            <div class="alert alert-warning mt-5">
                ...
                Usuário inativado! Se achar que isso é um erro, entre em contato com a secretaria.
            </div>
        @endif
    @else
        <div class="alert alert-primary mt-5">
            <i class="bx bxs-info-circle" style="font-size: 1.2em"></i>
            Hoje não é dia de chamada!
        </div>
    @endif
@endsection
